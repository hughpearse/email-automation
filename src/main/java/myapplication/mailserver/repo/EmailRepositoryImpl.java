...
public class EmailRepositoryImpl implements EmailRepositoryCustom {
	...
	public List<EmailSummarySubsetProjection> search(String queryStr, String emailAddress, Integer page, Integer limit) {
		...
		Query combinedQuery = queryBuilder
				  ...
				  .must(queryBuilder.keyword().onFields("subjectText", "bodyText", "fromAddress").matching(queryStr).createQuery())
				  .createQuery();
